...
function calcularMediaFaturamento(dados: { dia: number; valor: number }[]
    ): number  {
...
function calcularDiasMaiorMedia(dados: {dia: number, valor: number}[]): number[] {
...
console.log(`O número de dias com faturamento maior que a média é: ${diasMaiorMedia}`)   
